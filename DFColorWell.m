...
@interface DFColorWell () <NSPopoverDelegate>
...
- (void) _handleMouseUpInButtonRect {
    BFColorPickerPopover *panel = [BFColorPickerPopover sharedPopover];
    if (_shouldDrawButtonRegionWithSelectedColor == YES) {
        ...
        panel.delegate = self;
        [panel showRelativeToRect:self._controlButtonFrame ofView:self preferredEdge:NSMinYEdge];
    }
